...
export const pacoteApi = {
  ...
  // Ações específicas
  registrarPagamento: (id, dados) => api.patch(`/pacotes/${id}/pagar`, dados),
  ...
  // Agendamentos
  listarAgendamentosPacote: (pacoteId) =>
    api.get(`/pacotes/${pacoteId}/agendamentos`),
  ...
  listarAgendamentos: (pacoteId) =>
    api.get("/agendamentos", { params: { pacote_id: pacoteId } }),
